...
// Get a specific event rule by ID - accessible to all users
eventRuleRouter.get('/:id', eventRuleController.getEventRule);
// Create a new event rule - restricted to admin users
eventRuleRouter.post('/', authAdmin, eventRuleController.createEventRule);
// Update an existing event rule - restricted to admin users
eventRuleRouter.put('/:id', authAdmin, eventRuleController.updateEventRule);
// Delete an event rule - restricted to admin users
eventRuleRouter.delete('/:id', authAdmin, eventRuleController.deleteEventRule);
